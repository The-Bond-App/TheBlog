  ...
  return (
    <footer className="bg-foreground text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
        <motion.div
          className="grid grid-cols-1 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-12 lg:gap-8 mb-12"
        ...
        >
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-2xl tracking-tight">The Bond</span>
            </div>
          ...
          {['explore', 'getInvolved', 'resources'].map((section) => (
            <div key={section}>
              <h3 className="text-xs font-bold uppercase tracking-widest mb-6 text-white/50 font-mono">
