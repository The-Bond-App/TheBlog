      ...
      <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {currentPosts.length > 0 && (
            <motion.article
              className="group bg-white overflow-hidden hover:shadow-md transition-all duration-500 cursor-pointer mb-24"
            ...
            >
              <div className="flex flex-col md:flex-row">
                <div className="relative md:w-1/2 aspect-[16/9] md:aspect-[3/2] overflow-hidden bg-gradient-to-br from-stone-100 to-stone-200">
                  <motion.img
                ...
                <div className="md:w-1/2 p-9 flex flex-col justify-center">
                  <h2 className="font-inter text-6xl font-extrabold text-[#5a5187] mb-6 leading-tight group-hover:text-slate-700 transition-colors duration-300">
