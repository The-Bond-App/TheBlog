...
import { Menu, X, Mail, ShoppingBag, Users, Sticker, Facebook, Instagram, Linkedin, Youtube, Globe, MicVocal } from 'lucide-react';
    ...
    <div className="min-h-screen  py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div
          ...
          className="space-y-3"
        >
          <h1 className="font-serif text-5xl md:text-6xl text-slate-700">
            Sticky notes for your <span className="block font-light gradient-text pb-2"> soul's fridge</span> 
          </h1>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
    {currentPosts.map((post, index) => (
      <>
        ...
        >
          ...
          <div className="p-8">
            ...
            <div className="flex items-center gap-4 mb-6">
              <span className="bg-gray-900 text-white px-4 py-1.5 text-sm font-medium">
                {post.category}
              </span>
        ...
        {index === 5 && (
          <article className="bg-white rounded-2xl overflow-hidden md:col-span-2 mx-18 my-10">
            {/* Featured Image */}
            <div className="aspect-[21/6] w-full overflow-hidden bg-gray-900">
              <img
            ...
            {/* Content */}
            <div className="p-8">
              <h1 className="text-5xl sm:text-6xl md:text-4xl font-bold text-gray-800 mb-4 leading-tight">
              ...
              <p className="text-xl text-slate-500 leading-relaxed max-w-4xl">
                In the intricate tapestry of human existence, dreams serve as the vibrant threads that weave our aspirations into the fabric of reality.
              </p>
            </div>
          </article>
        )}
